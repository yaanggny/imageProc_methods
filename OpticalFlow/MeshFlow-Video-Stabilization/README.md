![stable-output](results/sample.gif)
...
Ref: [Mesh-Flow-Video-Stabilization](https://github.com/sudheerachary/Mesh-Flow-Video-Stabilization)
Fixed README and to support python3.

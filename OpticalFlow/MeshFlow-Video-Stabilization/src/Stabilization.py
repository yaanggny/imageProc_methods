...
from Optimization import real_time_optimize_path, offline_optimize_path
...
def read_video(cap):
    ...
    # path parameters
    h, w = old_frame.shape[0]//PIXELS, old_frame.shape[1]//PIXELS
    x_paths = np.zeros((h, w, 1))
    y_paths = np.zeros((h, w, 1))
